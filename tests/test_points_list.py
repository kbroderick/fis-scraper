...
def test_parse_title(scraper):
    ...
    text = __sample_normal_row_soup().div.text
    ...
    text = __sample_internal_base_row_soup().div.text
    result = scraper._parse_title(text)
    ...
    text = __sample_normal_row_single_ordinal_soup().div.text
    result = scraper._parse_title(text)
    ...
    # another base list
    text = __sample_base_row_soup().div.text
    result = scraper._parse_title(text)
...
def test_parse_list_row(scraper):
    row = scraper._parse_list_row(__sample_normal_row_soup().div)
...
def __sample_internal_base_row_soup():
...
def __sample_normal_row_single_ordinal_soup():
